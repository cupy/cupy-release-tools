...
switch ($cuda) {
    ...
    "10.1" {
        ...
        $cudnn_version = "8.0.4"
        $cudnn_archive = "cudnn-10.1-windows10-x64-v8.0.4.30.zip"
    }
    "10.2" {
        $cuda_path = $Env:CUDA_PATH_V10_2
        $cudnn_version = "8.0.4"
        $cudnn_archive = "cudnn-10.2-windows10-x64-v8.0.4.30.zip"
    }
    "11.0" {
        $cuda_path = $Env:CUDA_PATH_V11_0
        $cudnn_version = "8.0.4"
        $cudnn_archive = "cudnn-11.0-windows-x64-v8.0.4.30.zip"
    }
    "11.1" {
        $cuda_path = $Env:CUDA_PATH_V11_1
        $cudnn_version = "8.0.4"
        $cudnn_archive = "cudnn-11.1-windows-x64-v8.0.4.30.zip"
    }
    default {
